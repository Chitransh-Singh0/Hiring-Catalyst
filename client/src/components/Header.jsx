        ...
        <div className='bg-[#f7fdfd]'>
            <div className={`container mx-auto px-5 ${type ? "h-[500px]" : "h-[350px]"} flex items-center relative`}>
                ...
                <div className='w-full z-10'>
                    ...
                    {
                        type && (<div className='w-full lg:1/2 flex flex-wrap gap-3 md:gap-6 py-10 md:py-14'>
                ...
                <div className='w-1/5 h-full absolute top-22 md:-top-6 lg:-top-14 right-16 2xl:right-[18rem]'>
                    <img 
                    src={Main}
